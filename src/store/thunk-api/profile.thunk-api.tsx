...
const updateProfile = createAsyncThunk("profile/updateProfile", async (data: TEditProfileFormSchema) => {
    return await updateProfileDataService(data);
});

const updateProfileAvatar = createAsyncThunk("profile/updateProfileAvatar", async (data: FormData) => {
    return await updateProfileAvatarService(data);
});

const updateProfileCoverImage = createAsyncThunk("profile/updateProfileCoverImage", async (data: FormData) => {
    return await updateProfileCoverImageService(data);
});

export { getProfile, updateProfile, updateProfileAvatar, updateProfileCoverImage };
